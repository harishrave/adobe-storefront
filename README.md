...
## Environments
- Preview: https://main--adobe-storefront--harishrave.aem.page/
- Live: https://main--adobe-storefront--harishrave.aem.live/
...
1. Open the `adobe-storefront` directory in your favourite IDE and start coding :)
